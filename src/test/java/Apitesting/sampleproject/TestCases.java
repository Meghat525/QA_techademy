...
//	POST
	...
	public void testCreateUser(){
		...
		ExtentReportManager.test.log(LogStatus.INFO, "Payload", "{name: \"Megha\", job: \"QA\"}");
		...
		params.put("name", "Megha");
		params.put("job", "QA");
		given().when().contentType("application/json").body(params).post("api/users").then().assertThat().body("name", IsEqual.equalTo("Megha"));
